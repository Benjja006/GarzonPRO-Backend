...
public class GlobalExceptionHandler {
    ...
    // CAPTURA CAMPOS INVÁLIDOS (Ej: Precio negativo, nombre vacío)
    ...
    // CAPTURA TEXTO EN CAMPOS NUMÉRICOS (Ej: "precio": "gratis" o "precio": "")
    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Map<String, String>> handleInvalidFormatException(HttpMessageNotReadableException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", "Error de formato en la petición: Verifique que los campos numéricos contengan valores válidos.");
